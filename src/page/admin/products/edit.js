                    ...
                    <form id="formEdit">
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                            ...
                            ${cate.data.map((post) => `
                             ...
                             <option value="${post.id}" ${post.id === data.catePostId ? "selected" : ""}>${post.name}</option>
                            ...
                            `).join("")}
                                ...
                                <div class="mt-1">
                                <input type="number" id="soluong_product" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm h-[30px] border border-gray-300 rounded-md p-1" value="${data.quantity}">
                                </div>
                            </div>
                            </div>
                                <div>
